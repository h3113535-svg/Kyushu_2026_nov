...
const CACHE = "kyushu-nov-v1.9.1";
const SHELL = [
  "./","./index.html","./style.css?v=191","./app.js?v=191",
  "./manifest.json","./firebase-config.js?v=191","./icon-192.png","./icon-512.png","./icon-maskable-512.png",
