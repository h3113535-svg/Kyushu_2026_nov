...
const CACHE = "kyushu-nov-v1.9.5";
const SHELL = [
  "./","./index.html","./style.css?v=195","./app.js?v=195",
  "./manifest.json","./firebase-config.js?v=195","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./nov_app_icon_v195.webp?v=195",
