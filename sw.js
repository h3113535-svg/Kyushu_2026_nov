...
const CACHE = "kyushu-nov-v1.9.0";
const SHELL = [
  "./","./index.html","./style.css?v=190","./app.js?v=190",
  "./manifest.json","./firebase-config.js?v=190","./icon-192.png","./icon-512.png","./icon-maskable-512.png",
